<div class="content-wrapper">
    ...
    ?>
	 ...
	 <?php if ($tnilai > 0 and $rnilai["nilai"] != "") { ?>
                          <a data-toggle="modal" data-target="#myModal<?php echo $s[
                              "id_ujian"
                          ]; ?>" href="<?php echo $s[
    "id_ujian"
]; ?>" class="badge badge-pill badge-info" style="font-size: 14px;">
                   ...
                   <table class="table">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><a data-toggle="modal" data-target="#soalEssay<?php echo $s[
                            "id_ujianessay"
                        ]; ?>" href="<?php echo $s[
    "id_ujianessay"
]; ?>" class="badge badge-pill badge-primary" style="font-size: 14px;"> <i class="fa fa-pencil"></i>
                          <?= $s["mapel"] ?> - <?= $s[
     "semester"
 ] ?>                          
                          </a> 
                                                       <!-- Modal -->
                      <div class="modal fade bs-example-modal-lg" id="soalEssay<?php echo $s[
                          "id_ujianessay"
                      ]; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                        <div class="modal-dialog modal-lg" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-footer">
                              <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                              <a href="../Report/soal/print_soalessay.php?ID=<?= $s[
                                  id_ujianessay
                              ] ?>" target="_blank" class="btn btn-primary"> <i class="fa fa-download text-white"></i> Download Soal</a>
                            </div>
                          </div>
                        </div>
                      </div>
